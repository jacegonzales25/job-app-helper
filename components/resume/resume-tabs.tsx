    ...
    <div className="container mx-auto p-4 min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800">
      <Card className="w-full max-w-5xl mx-auto shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">
            Resume Builder
          </CardTitle>
          <CardDescription className="text-lg mt-2">
            Create your comprehensive professional resume
          </CardDescription>
        </CardHeader>
